...
save('../DC_Noisy_data/Case0_15.mat', 'noisy_img', 'img');

% niose level 35
Omsi       = img;          
noiselevel = 0.35*ones(1,191); 
...
save('../DC_Noisy_data/Case0_35.mat', 'noisy_img', 'img');

% niose level 55
Omsi       = img;          
noiselevel = 0.55*ones(1,191); 
...
save('../DC_Noisy_data/Case0_55.mat', 'noisy_img', 'img');

%% Simulated experiment 1
Omsi       = img;
ratio      = 0.1*ones(1,191);           
noiselevel = 0.1*ones(1,191); 
...
save('../DC_Noisy_data/Case1.mat', 'noisy_img', 'img');
...
save('../DC_Noisy_data/Case2.mat', 'noisy_img', 'img');
...
save('../DC_Noisy_data/Case3.mat', 'noisy_img', 'img');
...
save('../DC_Noisy_Data/Case4.mat', 'noisy_img', 'img');
...
save('../DC_Noisy_data/Case5.mat', 'noisy_img', 'img');
...
save('../DC_Noisy_data/Case6.mat', 'noisy_img', 'img');
