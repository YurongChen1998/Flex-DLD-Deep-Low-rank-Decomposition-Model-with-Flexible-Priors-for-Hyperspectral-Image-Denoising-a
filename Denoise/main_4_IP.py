...
parser.add_argument('--LR_iter',  default = 2000,           help="Training epochs of deep Low-rank networks")
parser.add_argument('--R_iter',   default = 600,            help="Reduced Training epochs of deep Low-rank networks")
parser.add_argument('--lambda_R', default = 0.07,           help="Factor of TV/SSTV regularization in DLD")
...
#----------------------- Data Configuration -----------------------#
dataset_dir = '../Data/IP_Noisy_data'
data_name = args.case

if data_name == 'Case0_15':
    args.LR_iter, args.R_iter, args.lambda_R = 2500, 900, 0.05
elif data_name == 'Case0_35':
    args.LR_iter, args.R_iter, args.lambda_R = 2000, 600, 0.07
elif data_name == 'Case0_55':
    args.LR_iter, args.R_iter, args.lambda_R = 2000, 600, 0.10
else:
    args.LR_iter, args.R_iter, args.lambda_R = 2200, 700, 0.01
