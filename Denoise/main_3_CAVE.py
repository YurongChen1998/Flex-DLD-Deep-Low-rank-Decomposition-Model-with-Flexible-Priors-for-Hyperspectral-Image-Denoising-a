...
parser.add_argument('--LR_iter',  default = 1000,           help="Training epochs of deep Low-rank networks")
...
if data_name == 'Case0_15':
    args.LR_iter, args.R_iter, args.lambda_R = 1700, 900, 0.01
elif data_name == 'Case0_35':
    args.LR_iter, args.R_iter, args.lambda_R = 1000, 700, 0.03
elif data_name == 'Case0_55':
    args.LR_iter, args.R_iter, args.lambda_R = 1000, 600, 0.06
else:
    args.LR_iter, args.R_iter, args.lambda_R = 2200, 1000,0.01
