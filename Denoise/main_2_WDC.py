...
parser.add_argument('--LR_iter',  default = 2200,           help="Training epochs of deep Low-rank networks")
parser.add_argument('--R_iter',   default = 400,            help="Reduced Training epochs of deep Low-rank networks")
...
#----------------------- Data Configuration -----------------------#
dataset_dir = '../Data/DC_Noisy_data'
data_name = args.case

if data_name == 'Case0_15':
    args.LR_iter, args.R_iter, args.lambda_R = 3000, 700, 0.03
elif data_name == 'Case0_35':
    args.LR_iter, args.R_iter, args.lambda_R = 2200, 400, 0.03
